...
mean(pred_ensemble_mediana_foldado$auc)

sd(pred_ensemble_mediana_foldado$auc)
...
plota_roc_modelo(model_gamboost, 0.25, "Gam Boost")
...
# 
#     
 fold <- model_logistic$pred %>% filter(Resample == "Fold1.Rep01")
